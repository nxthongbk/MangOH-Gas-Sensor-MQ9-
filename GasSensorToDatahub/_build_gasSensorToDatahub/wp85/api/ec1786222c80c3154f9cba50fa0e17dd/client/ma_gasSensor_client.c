...
#include "ma_gasSensor_interface.h"
#include "ma_gasSensor_messages.h"
...
typedef struct
{
    ...
    ma_gasSensor_DisconnectHandler_t disconnectHandler; ///< Disconnect handler for this thread
...
)
{
    ...
    LE_FATAL_IF(clientThreadPtr==NULL,
                "ma_gasSensor_ConnectService() not called for current thread");
...
static void InitCommonData(void)
{
    ...
    _ClientDataPool = le_mem_CreatePool("ma_gasSensor_ClientData", sizeof(_ClientData_t));

    // Allocate the client thread pool
    _ClientThreadDataPool = le_mem_CreatePool("ma_gasSensor_ClientThreadData", sizeof(_ClientThreadData_t));
    ...
    _HandlerRefMap = le_ref_CreateMap("ma_gasSensor_ClientHandlers", 5);
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void ma_gasSensor_ConnectService
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t ma_gasSensor_TryConnectService
(
    void
)
{
...
)
{
    ...
    LE_FATAL("Component for ma_gasSensor disconnected\n");
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void ma_gasSensor_SetServerDisconnectHandler
(
    ma_gasSensor_DisconnectHandler_t disconnectHandler,
    void *contextPtr
)
{
    _ClientThreadData_t* clientThreadPtr = GetClientThreadDataPtr();
 ...
 */
//--------------------------------------------------------------------------------------------------
void ma_gasSensor_DisconnectService
(
    void
)
{
