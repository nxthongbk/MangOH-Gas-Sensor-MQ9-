...
// Startup code for the executable 'gasSensorToDatahub'.
...
LE_SHARED const char* _gasSensorToDatahubComponent_io_ServiceInstanceName = "gasSensorToDatahub.gasSensorToDatahubComponent.io";
LE_SHARED const char* _gasSensorToDatahubComponent_ma_gasSensor_ServiceInstanceName = "gasSensorToDatahub.gasSensorToDatahubComponent.ma_gasSensor";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t gasSensorToDatahub_exe_LogSession;
LE_SHARED le_log_Level_t* gasSensorToDatahub_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    gasSensorToDatahub_exe_LogSession = log_RegComponent("gasSensorToDatahub_exe", &gasSensorToDatahub_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_gasSensorToDatahubComponent.so");
