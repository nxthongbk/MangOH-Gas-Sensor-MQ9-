...
// Startup code for the executable 'gasSensor'.
...
LE_SHARED const char* _gasSensorComponent_ma_gasSensor_ServiceInstanceName = "ma_gasSensor";
LE_SHARED const char* _gasSensorComponent_le_adc_ServiceInstanceName = "gasSensor.gasSensorComponent.le_adc";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t gasSensor_exe_LogSession;
LE_SHARED le_log_Level_t* gasSensor_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    gasSensor_exe_LogSession = log_RegComponent("gasSensor_exe", &gasSensor_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_gasSensorComponent.so");
