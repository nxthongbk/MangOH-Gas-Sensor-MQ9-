...
// Startup code for the executable 'gasSensorDisplay'.
...
LE_SHARED const char* _gasSensorDisplayComponent_io_ServiceInstanceName = "gasSensorDisplay.gasSensorDisplayComponent.io";
LE_SHARED const char* _gasSensorDisplayComponent_admin_ServiceInstanceName = "gasSensorDisplay.gasSensorDisplayComponent.admin";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t gasSensorDisplay_exe_LogSession;
LE_SHARED le_log_Level_t* gasSensorDisplay_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    gasSensorDisplay_exe_LogSession = log_RegComponent("gasSensorDisplay_exe", &gasSensorDisplay_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_gasSensorDisplayComponent.so");
